...
namespace DndApiNetCore.Controllers
{
    ...
    {
        readonly ICharacterService _service;
        ...
        [HttpPost]
        public IActionResult Insert(CharacterDto entity)
        {
            return Ok(_service.Insert(entity));
        }
        [HttpPost]
        public IActionResult Insert(IEnumerable<CharacterDto> list)
        {
            return Ok(_service.Insert(list));
        }

        [HttpPut]
        public IActionResult Update(CharacterDto entity)
        {
            return Ok(_service.Update(entity));
        }
        [HttpPut]
        public IActionResult Update(IEnumerable<CharacterDto> list)
        {
