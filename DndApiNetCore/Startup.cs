...
using DndApiNetCore.Middleware;
...
namespace DndApiNetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            ContextServices.GetContextRegisters(services,Configuration);
            DependencyInjections.AddDependencyResolver(services);
